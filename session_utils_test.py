...
def test_get_known_areas_from_list():
    """Test extracting unique areas from a list of NPCs."""
    npcs = [
        {"area": "Area1", "name": "NPC1"},
        {"area": "Area2", "name": "NPC2"},
        {"area": "Area1", "name": "NPC3"}
    ]
...
def test_build_system_prompt(mock_terminal_formatter):
    ...
    npc_data = {
        ...
        "role": "Test Role",
        "area": "Test Area",
        "motivation": "Sei un test NPC in Eldoria.",
        "goal": "Test Goal",
        "playerhint": "Test Hint"
    }
    ...
    game_session_state = {
        ...
        "player_profile_cache": player_profile
    }
    ...
    assert "Sei un test NPC" in prompt  # Look for Italian phrase instead
...
def test_start_conversation_with_specific_npc(mock_insights, mock_db, mock_terminal_formatter, mock_llm_wrapper):
    ...
    with patch('chat_manager.ChatSession') as MockChatSession:
        ...
        npc, session = session_utils.start_conversation_with_specific_npc(
            ...
            mock_terminal_formatter,
            game_session_state={"player_id": "test_player"},
            llm_wrapper_for_profile_distillation=mock_llm_wrapper
        )
